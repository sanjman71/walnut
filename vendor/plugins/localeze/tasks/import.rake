...
namespace :localeze do
  ...
  LOCALEZE_DATA_DIR = "/Users/sanjay/Desktop/EnhancedBuild_200903/"
  ...
  task :clean_base_records do
    ...
    input   = "#{LOCALEZE_DATA_DIR}BaseRecords.txt"
    output  = "#{LOCALEZE_DATA_DIR}BaseRecords.csv"
    cleaned = 0
    wrote   = 0
  ...
  task :import_base_records do
    ...
    file      = "#{LOCALEZE_DATA_DIR}BaseRecords.csv"
  ...
  task :import_custom_attributes do
    ...
    file      = "#{LOCALEZE_DATA_DIR}CustomAttributes.txt"
    options   = { :validate => false } 
    id        = 1
    base_ids  = find_all_base_record_ids
  ...
  task :import_company_payment_types do
    ...
    file      = "#{LOCALEZE_DATA_DIR}CompanyPaymentTypes.txt"
    options   = { :validate => false } 
    id        = 1
    base_ids  = find_all_base_record_ids
  ...
  task :import_company_phones do
    ...
    file    = "#{LOCALEZE_DATA_DIR}CompanyPhones.txt"
    options = { :validate => false } 
    id      = 1
    base_ids  = find_all_base_record_ids
